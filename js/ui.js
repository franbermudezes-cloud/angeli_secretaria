...
import { calendarDetails, scheduleState, scheduleTitle, scheduleWhen } from "./schedule.js?v=0.21.89";
import { noteClassificationLabel, noteTitle } from "./notes.js?v=0.21.89";
import { normalizeNoteSettings, settingLabel } from "./note-settings.js?v=0.21.89";
import { whatsappChoices, whatsappPhone } from "./whatsapp.js?v=0.21.89";
import { normalizeNotificationSettings } from "./notification-settings.js?v=0.21.89";
import { filterMediaLibrary, mediaSize } from "./media-library.js?v=0.21.89";
import { mediaContextRelation, normalizeMediaContext } from "./media-context.js?v=0.21.89";
import { groupDietarioByDay } from "./dietario.js?v=0.21.89";
...
export function createUI({ getMedia }) {
  ...
  function workingBody(detail) {
    ...
    image.src = "assets/angeli-welcome.gif?v=0.21.89";
