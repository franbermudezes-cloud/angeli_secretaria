import { typeLabel } from "./classifier.js?v=0.21.52";
import { calendarDetails, scheduleState, scheduleTitle, scheduleWhen } from "./schedule.js?v=0.21.52";
import { noteClassificationLabel, noteTitle } from "./notes.js?v=0.21.52";
import { normalizeNoteSettings, settingLabel } from "./note-settings.js?v=0.21.52";
import { whatsappChoices, whatsappPhone } from "./whatsapp.js?v=0.21.52";
import { normalizeNotificationSettings } from "./notification-settings.js?v=0.21.52";
...
export function createUI({ getMedia }) {
  ...
  function workingBody(detail) {
    ...
    image.src = "assets/angeli-welcome.gif?v=0.21.52";
