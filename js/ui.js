import { typeLabel } from "./classifier.js?v=0.26.7";
import { calendarDetails, scheduleState, scheduleTitle, scheduleWhen } from "./schedule.js?v=0.26.7";
import { noteClassificationLabel, noteTitle } from "./notes.js?v=0.26.7";
import { normalizeNoteSettings, settingLabel } from "./note-settings.js?v=0.26.7";
import { whatsappChoices, whatsappPhone } from "./whatsapp.js?v=0.26.7";
import { SHOPPING_STORE_PRESETS, shoppingStoreLabel, isMercadonaList } from "./shopping.js?v=0.26.7";
import { normalizeNotificationSettings } from "./notification-settings.js?v=0.26.7";
import { filterMediaLibrary, mediaSize } from "./media-library.js?v=0.26.7";
import { mediaContextRelation, normalizeMediaContext } from "./media-context.js?v=0.26.7";
import { groupDietarioByDay } from "./dietario.js?v=0.26.7";
import { calendarAnswer, clashWarning, spokenWhen } from "./agenda.js?v=0.26.7";
...
export function createUI({ getMedia }) {
  ...
  let modalSpoken = "";
  // `spoken`: lo que se dice en voz alta en el modo conversación, en frase
  // natural. Si falta, se lee el título y la explicación del modal.
  function openModal({ title, lead, body, actions = [], spoken = "" }) {
    clearTimeout(completionTimer);
    modalSpoken = spoken;
  ...
  function workingBody(detail) {
    ...
    image.src = "assets/angeli-welcome.gif?v=0.26.7";
  ...
  function showCompletion({ title, lead, body = "", spoken = "" }) {
    openModal({ title, lead, body, actions: [], spoken });
...
function dueWhen(schedule = {}) {
  return schedule?.dueAt ? spokenWhen({ start: schedule.dueAt, allDay: false }) : "a la hora indicada";
}
