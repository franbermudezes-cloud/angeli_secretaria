import { typeLabel } from "./classifier.js?v=0.22.3";
import { calendarDetails, scheduleState, scheduleTitle, scheduleWhen } from "./schedule.js?v=0.22.3";
import { noteClassificationLabel, noteTitle } from "./notes.js?v=0.22.3";
import { normalizeNoteSettings, settingLabel } from "./note-settings.js?v=0.22.3";
import { whatsappChoices, whatsappPhone } from "./whatsapp.js?v=0.22.3";
import { normalizeNotificationSettings } from "./notification-settings.js?v=0.22.3";
import { filterMediaLibrary, mediaSize } from "./media-library.js?v=0.22.3";
import { mediaContextRelation, normalizeMediaContext } from "./media-context.js?v=0.22.3";
import { groupDietarioByDay } from "./dietario.js?v=0.22.3";
...
export function createUI({ getMedia }) {
  ...
  function workingBody(detail) {
    ...
    image.src = "assets/angeli-welcome.gif?v=0.22.3";
