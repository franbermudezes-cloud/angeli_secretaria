import { typeLabel } from "./classifier.js?v=0.21.51";
import { calendarDetails, scheduleState, scheduleTitle, scheduleWhen } from "./schedule.js?v=0.21.51";
import { noteClassificationLabel, noteTitle } from "./notes.js?v=0.21.51";
import { normalizeNoteSettings, settingLabel } from "./note-settings.js?v=0.21.51";
import { whatsappChoices, whatsappPhone } from "./whatsapp.js?v=0.21.51";
...
export function createUI({ getMedia }) {
  ...
  function workingBody(detail) {
    ...
    image.src = "assets/angeli-welcome.gif?v=0.21.51";
