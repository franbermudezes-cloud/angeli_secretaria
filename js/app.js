import{clearNotes,deleteMediaDB,readShortcuts,writeShortcuts}from"./storage.js?v=0.21.9";
import{classify,actionData}from"./classifier.js?v=0.21.9";
import{sendEntry}from"./sheets.js?v=0.21.9";
import{createUI}from"./ui.js?v=0.21.9";
import{createGoogleIntegration}from"./google.js?v=0.21.9";
import{interpret,remoteProvider,localReminderQuery}from"./ai.js?v=0.21.9";
import{entryTypeForIntent,planIntent}from"./intents.js?v=0.21.9";
import{calendarQueryRange,temporalData}from"./temporal.js?v=0.21.9";
import{normalizeFutureCall,normalizeReminderSchedule,scheduleFor}from"./schedule.js?v=0.21.9";
import{createCloudSync}from"./firebase.js?v=0.21.9";
import{createMediaService}from"./media.js?v=0.21.9";
import{cancelInteraction,completeInteraction,contextFor,resolveConversationTurn}from"./conversation.js?v=0.21.9";
import{completionTarget,completePending,findPendingMatches,findReminderMatches}from"./pending.js?v=0.21.9";
...
if("serviceWorker"in navigator)navigator.serviceWorker.register("sw.js?v=0.21.9",{updateViaCache:"none"}).then(registration=>registration.update()).catch(()=>{});
load();
