import{clearNotes,deleteMediaDB,readShortcuts,writeShortcuts}from"./storage.js?v=0.21.27";
import{classify,actionData}from"./classifier.js?v=0.21.27";
import{sendEntry}from"./sheets.js?v=0.21.27";
import{createUI}from"./ui.js?v=0.21.27";
import{createGoogleIntegration}from"./google.js?v=0.21.27";
import{interpret,remoteProvider,localReminderQuery,localCalendarCancellation,localCalendarUpdate,localLinkedCalendarIntent,protectCalendarInterpretation}from"./ai.js?v=0.21.27";
import{entryTypeForIntent,planIntent}from"./intents.js?v=0.21.27";
import{calendarQueryRange,temporalData}from"./temporal.js?v=0.21.27";
import{normalizeFutureCall,normalizeReminderSchedule,normalizeUndatedCall,deferredCallIntent,scheduleFor,linkedScheduleFor,updateCalendarDetails}from"./schedule.js?v=0.21.27";
import{createCloudSync}from"./firebase.js?v=0.21.27";
import{createMediaService}from"./media.js?v=0.21.27";
import{cancelInteraction,completeInteraction,contextFor,resolveConversationTurn,preserveCancellation}from"./conversation.js?v=0.21.27";
import{completionTarget,completePendingWithCalendar,findPendingMatches,findReminderMatches,markCancelledReminder}from"./pending.js?v=0.21.27";
import{createAgendaActions}from"./agenda.js?v=0.21.27";
...
if("serviceWorker"in navigator)navigator.serviceWorker.register("sw.js?v=0.21.27",{updateViaCache:"none"}).then(registration=>registration.update()).catch(()=>{});
load();
